...
ZygorGuidesViewer:RegisterInclude("Klaxxi_Dailies",[[
	step
		...
		Click here to go to Zygor's Leveling and Loremaster guides for assistance in completing these questlines |confirm |next "Zygor's Leveling Guides\\Pandaria (85-90)\\Dread Wastes (89-90)"
		confirm
	step
	label "klaxxi start"
