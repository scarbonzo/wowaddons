...
model={37549},
condition_suggested="level>=48 and level<=52",
condition_valid="raceclass('Hunter')",
...
model={34912},
condition_suggested="level>=83 and level<=87",
condition_valid="raceclass('Hunter')",
condition_valid_msg="You must be a hunter to tame pets.",
},[[
step
...
model={18063},
condition_suggested="level>=63 and level<=68",
condition_valid="raceclass('Hunter')",
condition_valid_msg="You must be a hunter to tame pets.",
},[[
step
...
model={20348},
condition_suggested="level>=65 and level<=69",
condition_valid="raceclass('Hunter')",
condition_valid_msg="You must be a hunter to tame pets.",
},[[
step
...
model={18029},
condition_suggested="level>=61 and level<=66",
condition_valid="raceclass('Hunter')",
condition_valid_msg="You must be a hunter to tame pets.",
},[[
step
