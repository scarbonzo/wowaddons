...
local activeFrameBackdrop = CreateFrame("Frame", "PGF_activeFrameBackdrop", PGF_optionsKeywords)
...
local inactiveFrameBackdrop = CreateFrame("Frame", "PGF_inactiveFrameBackdrop", PGF_optionsKeywords)
...
function PGF_CreateActiveKeywordFrame(keyword)
	...
	local keywordFrameCheckButton = CreateFrame("CheckButton", "PGF_KeywordFrameCheckButton_"..keyword, keywordFrame, "OptionsCheckButtonTemplate")
